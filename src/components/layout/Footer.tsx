        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="text-muted-foreground hover:text-primary">Men's Glasses</Link></li>
              <li><Link href="#" className="text-muted-foreground hover:text-primary">Women's Glasses</Link></li>
              <li><Link href="#" className="text-muted-foreground hover:text-primary">Contact Lenses</Link></li>
              <li><Link href="#" className="text-muted-foreground hover:text-primary">Sunglasses</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-muted-foreground hover:text-primary">Order Tracking</Link></li>
              <li><Link href="#" className="text-muted-foreground hover:text-primary">Returns</Link></li>
            </ul>
          </div>
